...
class MemoryManager {
    ...
    // 加载回忆数据
    loadMemories() {
        return this.dataManager.getData('travel_memories', []);
    }

    // 保存回忆数据
    saveMemories() {
        this.dataManager.setData('travel_memories', this.memories);
    }

    // 加载照片数据
    loadPhotos() {
        return this.dataManager.getData('travel_photos', []);
    }

    // 保存照片数据
    savePhotos() {
        this.dataManager.setData('travel_photos', this.photos);
    }
